...
function Gtext() {
    ...
    G.MM_items      = [['🚀 Запустить все проверки, кроме менеджеров',                            'MM_launch_all_no_man'],
                       ...
                       ['separator'],   // разделительная линия
                       ['[Аа] Сделать в выделенном диапазоне первые буквы прописными, остальные строчными', 'MM_fontcase_default'],
                       ['[Аа] Сделать в выделенном диапазоне первую букву прописной, остальные не трогать', 'MM_fontcase_up_first'],
                       ['[АА] Сделать все буквы в выделенном диапазоне прописными',                'MM_fontcase_upper'],
                       ['[аа] Сделать все буквы в выделенном диапазоне строчными',                 'MM_fontcase_lower'],
                       ['separator'],   // разделительная линия
