...
function STR_check_email(string) {
    if      (string == '')                                     {return true}
        ...
        else if (domain.endsWith('.r'))               {return false}
...
function STR_trim_city(city) {
    const search = ['г. ', 'г ', 'г.', 'д. ', 'д ', 'д.', 'с. ', 'с ', 'с.', 'х. ', 'х ', 'х.', 'рп. ', 'рп ', 'рп.', 'дп. ', 'дп ', 'дп.', 'ст. ', 'ст ', 'ст.', 'посёлок ', 'посёлок', 'поселок ', 'поселок', 'пос. ', 'пос ', 'пос.', 'пгт. ', 'пгт ', 'пгт', 'городской пос. ', 'городской пос ', 'городской пос.', 'город ', 'город', 'станица ', 'станица', 'ст-ца ', 'ст-ца', 'хутор ', 'хутор', 'село ', 'село', 'деревня ', 'деревня'];
